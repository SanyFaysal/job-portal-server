...
router.route("/jobs/homeSearch").patch(jobController.getJobsHomeSearch);

router.route("/all-jobs").get(jobController.getAllJobs);
...
router
  .route("/employee/jobs")
  .get(verifyToken, authorization("employee"), jobController.getManagerJob);
router
